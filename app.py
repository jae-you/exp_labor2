...
TASKS = [
    {
        ...
        "options": [
            ...
            },
            {
                ...
                "desc": "초기에는 AI 안내, 사용자가 강하게 원하면 연결 허용.",
                "cost": 300,
                "eff": 70,
                "human": 60,
...

    {
        ...
        "options": [
            ...
            },
            {
                ...
                "desc": "ACW 시간을 제한(예: 60초)하고 이후 Ready 전환.",
                "cost": 300,
                "eff": 70,
                "human": 60,
            ...
            },
            {
                ...
                "desc": "상담사에게 충분한 ACW 보장(예: 180초 이상).",
                "cost": 500,
                "eff": 40,
                "human": 90,
...

    {
        ...
        "options": [
            ...
            },
            {
                ...
                "desc": "링크 + 간단 단계 안내 후, 미해결이면 상담 연결.",
                "cost": 300,
                "eff": 70,
                "human": 60,
            ...
            },
            {
                ...
                "desc": "디지털 전환 유도는 하되, 원하면 언제든 상담 연결.",
                "cost": 500,
                "eff": 40,
                "human": 90,
        ...
        "options": [
            {
                ...
                "desc": "AI 즉시 답변. 오류는 사후 모니터링으로 수정.",
                "cost": 100,
                "eff": 95,
                "human": 5,
