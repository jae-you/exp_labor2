...
<style>
  * {{ box-sizing:border-box; margin:0; padding:0; }}
  ...
  .deploy-btn {{ width:100%; margin-top:22px; padding:14px; background:#28a745; color:#fff; font-size:14px; font-weight:700; font-family:'Noto Sans KR',sans-serif; border:none; border-radius:8px; cursor:pointer; opacity:0.35; pointer-events:none; transition:opacity 0.2s; }}
